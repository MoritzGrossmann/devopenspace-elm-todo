...
getAll : Session -> (Result Http.Error (List Todos.Item) -> msg) -> TaskList.Id -> Cmd msg
...
update : Session -> (Result Http.Error Todos.Item -> msg) -> TaskList.Id -> Todos.Item -> Cmd msg
...
new : Session -> (Result Http.Error Todos.Item -> msg) -> TaskList.Id -> String -> Cmd msg
